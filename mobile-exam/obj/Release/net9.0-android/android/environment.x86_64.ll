...
@aot_dso_cache = dso_local local_unnamed_addr global [774 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.64_name, ; name: libaot-System.IO.Pipelines.dll.so
		ptr null; void* handle
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.68_name, ; name: libaot-System.Net.Http.Json.dll.so
		ptr null; void* handle
	}, ; 11
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.61_name, ; name: libaot-System.Formats.Asn1.dll.so
		ptr null; void* handle
	}, ; 41
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2dca964140fd88db, ; from name: libaot-mobile-exam
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
	}, ; 135
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x38bd9271f8405503, ; from name: libaot-MobileExam.Entities.so
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	}, ; 163
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3ec4b76e1f3e7170, ; from name: aot-MobileExam.Entities
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x40331521d80af232, ; from name: MobileExam.Entities.dll.so
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x41f617e7620c0d92, ; from name: aot-MobileExam.Entities.dll.so
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x4429d19804f22048, ; from name: aot-mobile-exam
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5e40f2051356d51b, ; from name: aot-mobile-exam.dll.so
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x670f512f299a0028, ; from name: MobileExam.Entities
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6d22418d123cf236, ; from name: libaot-mobile-exam.so
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x71a1c1b757088ceb, ; from name: libaot-MobileExam.Entities
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9ea28561b77003a6, ; from name: libaot-mobile-exam.dll.so
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb57638b4300370c4, ; from name: libaot-MobileExam.Entities.dll.so
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb587ff141f1d99b0, ; from name: mobile-exam.so
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb855944d8089a4c4, ; from name: aot-MobileExam.Entities.so
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbdfb58e2da3bb41d, ; from name: mobile-exam
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd2a6a71fc897c9f0, ; from name: MobileExam.Entities.so
		i64 u0xb57638b4300370c4, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MobileExam.Entities.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xea733e340d18e4e4, ; from name: mobile-exam.dll.so
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf4b88a957b74bd19, ; from name: aot-mobile-exam.so
		i64 u0x9ea28561b77003a6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobile-exam.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.mobileexam\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [34 x i8] c"libaot-MobileExam.Entities.dll.so\00", align 16
@.DSOCacheEntry.9_name = private unnamed_addr constant [26 x i8] c"libaot-mobile-exam.dll.so\00", align 16
...
@.DSOCacheEntry.61_name = private unnamed_addr constant [34 x i8] c"libaot-System.Formats.Asn1.dll.so\00", align 16
...
@.DSOCacheEntry.64_name = private unnamed_addr constant [34 x i8] c"libaot-System.IO.Pipelines.dll.so\00", align 16
...
@.DSOCacheEntry.68_name = private unnamed_addr constant [35 x i8] c"libaot-System.Net.Http.Json.dll.so\00", align 16
